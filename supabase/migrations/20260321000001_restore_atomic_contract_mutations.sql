-- ============================================
-- Migration: Restore Atomic Contract Mutations
-- Description:
--   - Reintroduce database-owned atomic create/update paths for contracts
--   - Keep SECURITY INVOKER so RLS still applies
--   - Restrict execution to authenticated application roles
-- ============================================
...
BEGIN
  ...
  IF (p_vendor_contact IS NULL) <> (p_vendor_email IS NULL) THEN
  ...
  IF p_vendor_contact IS NOT NULL THEN
...
REVOKE ALL ON FUNCTION public.create_contract_with_relations(
  UUID,
  TEXT,
  TEXT,
  TEXT,
...
REVOKE ALL ON FUNCTION public.update_contract_with_relations(
  UUID,
  TEXT,
  TEXT,
  TEXT,
...
GRANT EXECUTE ON FUNCTION public.create_contract_with_relations(
  UUID,
  TEXT,
  TEXT,
  TEXT,
...
GRANT EXECUTE ON FUNCTION public.update_contract_with_relations(
  UUID,
  TEXT,
  TEXT,
  TEXT,
